---
created: '2026-03-06'
description: Overview of the Alfred OS vault — what it is, how it works, and how to
  set it up
janitor_note: LINK001 — Wikilinks to [[_docs/*]] files are intentional references
  to system documentation (not vault records), and [[person/Your Name]] is an example
  placeholder. ORPHAN001 — This is the main getting-started guide, no inbound links
  expected.
name: Start Here
status: active
subtype: guide
