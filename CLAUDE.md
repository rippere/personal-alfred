---
janitor_note: FM001 — This is a Claude Code documentation file, not a vault record.
  No type/created fields needed. LINK001 issues are references to examples and system
  files, not broken links.
---
